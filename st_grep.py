    ...
    def run(self):
        ...
        for i in range(0,100):
            try:
                ...
                time.sleep(1)
                driver.get("https://www.quora.com/How-can-I-use-grep-command-in-Linux")
    ...
    def run(self):
        ...
        for i in range(0,100):
            try:
                ...
                driver.maximize_window()
                time.sleep(1)
                driver.get("https://www.quora.com/If-I-want-to-get-more-profit-in-15-years-can-I-invest-in-share-market")
